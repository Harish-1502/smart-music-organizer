...
def set_local_mode(monkeypatch):
    monkeypatch.setattr(tracks_route.settings, "app_lan_mode", False)
    monkeypatch.setattr(tracks_route.settings, "backend_host", "127.0.0.1")
    monkeypatch.setattr(tracks_route.settings, "api_auth_token", None)
...
def test_deep_scan_route_enabled_by_default_calls_scan_function(
    ...
    """
    set_local_mode(monkeypatch)
    monkeypatch.setattr(tracks_route.settings, "enable_deep_scan", True)
